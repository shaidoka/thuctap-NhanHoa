...
### 6. Sử dụng apache2 module để gửi log access và error về server
...
**Lưu ý: Phần output chỉ có thể khai báo logstash HOẶC elasticsearch. Ban đầu chúng ta cần khởi tạo kết nối đến server bằng elasticsearch trước nên ta phải comment phần này lại, sau đó đảo ngược lại**